...
{
    public partial class INFORMACIÓN_TIENDA: Form
    {
        private bool editando = false;
        private bool esAdministrador;

        public INFORMACIÓN_TIENDA(bool admin)
        {
            InitializeComponent();
            esAdministrador = admin;
            button_editarInformacion.Enabled = esAdministrador;
        }
        ...
        private void button_editarInformacion_Paint(object sender, PaintEventArgs e)
        {
